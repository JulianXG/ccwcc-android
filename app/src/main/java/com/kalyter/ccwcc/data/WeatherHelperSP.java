...
* */
public class WeatherHelperSP {
    private final String WEATHER_INTERFACE_LOCATION ="http://apis.baidu.com/heweather/weather/free";
    ...
    public WeatherHelperSP(View view) {
        mView=view;
        sharedPreferences = mView.getContext().getSharedPreferences(PREFERENCES_NAME, Context.MODE_PRIVATE);
    }
    ...
    public boolean saveWeather(String city) {
        ...
        try {
            ...
            String strUrl = WEATHER_INTERFACE_LOCATION
                    + "?city="
                    + mCity;
            ...
            if (jsonGET!=null&&jsonGET.getString("status_http_helper").equals("ok")) {
                ...
                if (status.equals("ok")) {
                    ...
                    jsonWeather.put("status", mView.getResources().getString(R.string.weather_obtain_error_message));
                }
            }else{
                jsonWeather.put("status", mView.getResources().getString(R.string.network_error_message));
            }
